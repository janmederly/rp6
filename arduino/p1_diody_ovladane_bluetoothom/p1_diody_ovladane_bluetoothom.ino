...
void loop() {
  ...
  switch (znak) {
    ...
    case 207: digitalWrite(5,HIGH);
      Serial.println(" LED-4 zapnuta"); break;
    case 208: digitalWrite(5,LOW);
      Serial.println(" LED-4 vypnuta"); break;
    case 209: digitalWrite(6,HIGH);
      Serial.println(" LED-5 zapnuta"); break;
    case 210: digitalWrite(6,LOW);
      Serial.println(" LED-5 vypnuta"); break;
    case 211: digitalWrite(7,HIGH);
      Serial.println(" LED-6 zapnuta"); break;
    case 212: digitalWrite(7,LOW);
      Serial.println(" LED-6 vypnuta"); break;
  }
  znak = 0;
}
